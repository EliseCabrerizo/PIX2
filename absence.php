...
<body>
	...
	<form id="article" action="traitement_absence.php" method="post" >
	<div id= "bigNews" >
		<div id = "news">
			Veuillez donner les infomations concernant vos élèves afin de leur envoyer un mail : </br>
			<label for ="Ecole">Ecole :</label><input type="text" name="Ecole" size ="40" maxlength="30" required/><br/>
			<label for ="TD">TD :</label><input type="text" name="TD" size ="40" maxlength="30" required/><br/>
			<label for ="DateA">Date absence :</label><input type="text" name="DateA" size ="40" maxlength="30" required/><br/>
			<textarea name="cont" placeholder="Ecrivez votre message" required style="width:700px;height:800px;"></textarea>
